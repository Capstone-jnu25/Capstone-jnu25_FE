            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
                <View style={styles.mainContainer}>
                    <View style={styles.contentContainer}>
                        ...
                        <TextInput placeholder="제목" placeholderTextColor={'#777'} style={styles.input} value={title} onChangeText={setTitle} />

                        <View style={styles.content}>
                            <CustomCheckbox label="선착순으로 받기" checked={isSelected} onChange={setIsSelected} />
